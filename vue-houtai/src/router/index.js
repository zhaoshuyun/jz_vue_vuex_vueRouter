...
export const asyncRoutes = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'details',
        hidden:true,
        component: () => import('@/pages/address/Details'),
        name: 'details',
        meta: { title: '地址详情', icon: 'tab' }
      }
    ]
  } ,{
    path: '/category',
    ...
    children: [
      ...
      },
      {
        path: 'details',
        hidden:true,
        component: () => import('@/pages/comment/Details'),
        name: 'details',
        meta: { title: '评论详情', icon: 'tab' }
      }
    ]
  } ,{
    path: '/order',
